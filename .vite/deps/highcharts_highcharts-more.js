...
var require_highcharts_more = __commonJS({
  "node_modules/highcharts/highcharts-more.js"(exports, module) {
    !function(t, e) {
      ...
      let N = p, { addEvent: T, correctFloat: C, defined: X, pick: Y } = y();
      function I(t10) {
        let e10, i10 = this;
      ...
      let { noop: tk } = y(), { arrayMax: tw, arrayMin: tA, isNumber: tS, merge: tN, pick: tT, stableSort: tC } = y(), tX = class {
        constructor(t10, e10) {
        ...
        setOptions() {
          ...
          t10.forEach(function(h2, p2) {
            l2 || (o2.stroke = tT(h2.borderColor, e10.borderColor, i10.color), o2.fill = h2.color || e10.color, o2.fill || (o2.fill = i10.color, o2["fill-opacity"] = n2 ?? 1), a2.stroke = tT(h2.connectorColor, e10.connectorColor, i10.color)), t10[p2].radius = this.getRangeRadius(h2.value), t10[p2] = tN(t10[p2], { center: t10[0].radius - t10[p2].radius + s10 }), l2 || tN(true, t10[p2], { bubbleAttribs: tN(o2), connectorAttribs: tN(a2), labelAttribs: r2 });
          }, this);
        }
        getRangeRadius(t10) {
      ...
      }, { setOptions: tY } = y(), { composed: tI } = y(), { addEvent: tR, objectEach: tE, pushUnique: tz, wrap: tD } = y();
      ...
      function tF(t10) {
        ...
        this && this.bubbleLegend && (i10.visible = !o2, i10.ignoreSeries = o2, e10 = tH(s10) >= 0, this.bubbleLegend.visible !== e10 && (this.update({ bubbleLegend: { enabled: e10 } }), this.bubbleLegend.visible = e10), i10.visible = o2);
      }
      function tG(t10, e10) {
      ...
      let tq = { compose: function(t10, e10) {
        tz(tI, "Series.BubbleLegend") && (tY({ legend: { bubbleLegend: tv } }), tD(t10.prototype, "drawChartBox", tO), tR(e10, "afterGetAllItems", tW), tR(e10, "itemClick", tF));
      } };
      var tV = f(260), t_ = f.n(tV);
      let { seriesTypes: { scatter: { prototype: { pointClass: tU } } } } = P(), { extend: tK } = y();
      class tZ extends tU {
        haloPath(t10) {
      ...
      tK(tZ.prototype, { ttBelow: false });
      let { composed: tj, noop: t$ } = y(), { series: tQ, seriesTypes: { column: { prototype: tJ }, scatter: t0 } } = P(), { addEvent: t1, arrayMax: t2, arrayMin: t3, clamp: t5, extend: t8, isNumber: t6, merge: t4, pick: t9, pushUnique: t7 } = y();
      function et() {
      ...
      class ei extends t0 {
        ...
        markerAttribs(t10, e10) {
          ...
          return this.chart.inverted ? t8(i10, { x: (t10.plotX || 0) - o2 / 2, y: (t10.plotY || 0) - s10 / 2 }) : i10;
        }
        pointAttribs(t10, e10) {
          let i10 = this.options.marker, s10 = i10 == null ? void 0 : i10.fillOpacity, o2 = tQ.prototype.pointAttribs.call(this, t10, e10);
        ...
        translateBubble() {
          ...
          for (; o2--; ) {
            ...
            "z" === this.zoneAxis && (a2.negative = (a2.z || 0) < (e10.zThreshold || 0)), t6(r2) && r2 >= s10 / 2 ? (a2.marker = t8(a2.marker, { radius: r2, width: 2 * r2, height: 2 * r2 }), a2.dlBox = { x: a2.plotX - r2, y: a2.plotY - r2, width: 2 * r2, height: 2 * r2 }) : (a2.shapeArgs = a2.plotY = a2.dlBox = void 0, a2.isInside = false);
          }
        }
        getPxExtremes() {
        ...
        getZExtremes() {
          ...
          if (e10.length) {
            ...
            if (t6(i10) && t6(s10)) return { zMin: i10, zMax: s10 };
          }
        }
        searchKDTree(t10, e10, i10, s10 = t$, o2 = t$) {
          return s10 = (t11, e11, i11) => {
            ...
            return s11 === o3 ? a2 = t11.index > e11.index ? t11 : e11 : s11 < 0 && o3 < 0 ? (a2 = s11 - (((_a = t11.marker) == null ? void 0 : _a.radius) || 0) >= o3 - (((_b = e11.marker) == null ? void 0 : _b.radius) || 0) ? t11 : e11, r2 = true) : a2 = s11 < o3 ? t11 : e11, [a2, r2];
          }, o2 = (t11, e11, i11) => !i11 && t11 > e11 || t11 < e11, super.searchKDTree(t10, e10, i10, s10, o2);
        }
      }
      ei.defaultOptions = t4(t0.defaultOptions, { dataLabels: { formatter: function() {
        let { numberFormatter: t10 } = this.series.chart, { z: e10 } = this.point;
        return t6(e10) ? t10(e10, -1) : "";
      }, inside: true, verticalAlign: "middle" }, animationLimit: 250, marker: { lineColor: null, lineWidth: 1, fillOpacity: 0.5, radius: null, states: { hover: { radiusPlus: 0 } }, symbol: "circle" }, minSize: 8, maxSize: "20%", softThreshold: false, states: { hover: { halo: { size: 5 } } }, tooltip: { pointFormat: "({point.x}, {point.y}), Size: {point.z}" }, turboThreshold: 0, zThreshold: 0, zoneAxis: "z" }), t8(ei.prototype, { alignDataLabel: tJ.alignDataLabel, applyZones: t$, bubblePadding: true, isBubble: true, keysAffectYAxis: ["y"], pointArrayMap: ["y", "z"], pointClass: tZ, parallelArrays: ["x", "y", "z"], trackerGroups: ["group", "dataLabelsGroup"], specialGroup: "group", zoneAxis: "z" }), t1(ei, "updatedData", (t10) => {
        delete t10.target.chart.bubbleZExtremes;
      }), t1(ei, "remove", (t10) => {
        delete t10.target.chart.bubbleZExtremes;
      }), P().registerSeriesType("bubble", ei);
      let { seriesTypes: { column: { prototype: { pointClass: { prototype: es } } }, arearange: { prototype: { pointClass: eo } } } } = P(), { extend: ea, isNumber: er } = y();
      class en extends eo {
        isValid() {
          return er(this.low);
        }
      }
      ea(en.prototype, { setState: es.setState });
      let { noop: el } = y(), { seriesTypes: { arearange: eh, column: ep, column: { prototype: ed } } } = P(), { addEvent: ec, clamp: eu, extend: eg, isNumber: ef, merge: em, pick: eb } = y();
      class ey extends eh {
        setOptions() {
          return em(true, arguments[0], { stacking: void 0 }), eh.prototype.setOptions.apply(this, arguments);
        }
        translate() {
      ...
      ey.defaultOptions = em(ep.defaultOptions, eh.defaultOptions, { borderRadius: { where: "all" }, pointRange: null, legendSymbol: "rectangle", marker: null, states: { hover: { halo: false } } }), ec(ey, "afterColumnTranslate", function() {
        ey.prototype.afterColumnTranslate.apply(this);
      }, { order: 5 }), eg(ey.prototype, { directTouch: true, pointClass: en, trackerGroups: ["group", "dataLabelsGroup"], adjustForMissingColumns: ed.adjustForMissingColumns, animate: ed.animate, crispCol: ed.crispCol, drawGraph: el, drawPoints: ed.drawPoints, getSymbol: el, drawTracker: ed.drawTracker, getColumnMetrics: ed.getColumnMetrics }), P().registerSeriesType("columnrange", ey);
      let { column: ex } = P().seriesTypes, { clamp: eP, merge: ev, pick: eM } = y();
      class eL extends ex {
        translate() {
      ...
      eN.defaultOptions = eA(tP.defaultOptions, { color: "#000000", grouping: false, linkedTo: ":previous", tooltip: { pointFormat: '<span style="color:{point.color}">●</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>' }, whiskerWidth: null }), ew(eN, "afterTranslate", function() {
        for (let t10 of this.points) t10.plotLow = t10.plotY;
      }, { order: 0 }), eS(eN.prototype, { pointArrayMap: ["low", "high"], pointValKey: "high", doQuartiles: false }), P().registerSeriesType("errorbar", eN);
      let { series: { prototype: { pointClass: eT } } } = P(), { noop: eC } = y(), { series: eX, seriesTypes: { column: eY } } = P(), { clamp: eI, isNumber: eR, extend: eE, merge: ez, pick: eD, pInt: eO, defined: eH } = y();
      class eB extends eX {
        translate() {
          ...
          this.generatePoints(), this.points.forEach((s10) => {
            ...
            (eR(p2) || false === e10.wrap) && (p2 = eR(p2) ? p2 / 180 * Math.PI : 0, d2 = eI(d2, t10.startAngleRad - p2, t10.endAngleRad + p2)), d2 = 180 * d2 / Math.PI, s10.shapeType = "path", s10.shapeArgs = { d: o2.path || [["M", -n2, -l2 / 2], ["L", r2, -l2 / 2], ["L", a2, -h2 / 2], ["L", a2, h2 / 2], ["L", r2, l2 / 2], ["L", -n2, l2 / 2], ["Z"]], translateX: i10[0], translateY: i10[1], rotation: d2 }, s10.plotX = i10[0], s10.plotY = i10[1], eH(s10.y) && t10.max - t10.min && (s10.percentage = (s10.y - t10.min) / (t10.max - t10.min) * 100);
          });
        }
        drawPoints() {
      ...
      eB.defaultOptions = ez(eX.defaultOptions, { dataLabels: { borderColor: "#cccccc", borderRadius: 3, borderWidth: 1, crop: false, defer: false, enabled: true, verticalAlign: "top", y: 15, zIndex: 2 }, dial: { backgroundColor: "#000000", baseLength: "70%", baseWidth: 3, borderColor: "#cccccc", borderWidth: 0, radius: "80%", rearLength: "10%", topWidth: 1 }, pivot: { radius: 5, borderWidth: 0, borderColor: "#cccccc", backgroundColor: "#000000" }, tooltip: { headerFormat: "" }, showInLegend: false }), eE(eB.prototype, { angular: true, directTouch: true, drawGraph: eC, drawTracker: eY.prototype.drawTracker, fixedBox: true, forceDL: true, noSharedTooltip: true, pointClass: class extends eT {
        setState(t10) {
          this.state = t10;
        }
      }, trackerGroups: ["group", "dataLabelsGroup"] }), P().registerSeriesType("gauge", eB);
      var eW = f(620), eF = f.n(eW);
      let { composed: eG } = y(), { addEvent: eq, pushUnique: eV } = y();
      function e_() {
      ...
      let eU = { compose: function(t10) {
        ...
        if (t10.fixedPosition && t10.inDragMode) {
          let i10, s10, o2 = this.chart, a2 = ((_a = o2.pointer) == null ? void 0 : _a.normalize(e10)) || e10, r2 = t10.fixedPosition.chartX - a2.chartX, n2 = t10.fixedPosition.chartY - a2.chartY, l2 = o2.graphLayoutsLookup;
      ...
      } }, { setAnimation: eK } = y(), { composed: eZ } = y(), { addEvent: ej, pushUnique: e$ } = y();
      function eQ() {
      ...
      let { seriesTypes: { bubble: { prototype: { pointClass: e8 } } } } = P(), e6 = class extends e8 {
        destroy() {
          var _a;
          return ((_a = this.series) == null ? void 0 : _a.layout) && this.series.layout.removeElementFromCollection(this, this.series.layout.nodes), t_().prototype.destroy.apply(this, arguments);
        }
        firePointEvent() {
      ...
      }, { isNumber: e4 } = y(), e9 = { attractive: function(t10, e10, i10) {
      ...
      } }, { noop: e7 } = y(), it = { barycenter: function() {
      ...
      }, getK: e7, integrate: e9.integrate, repulsive: function(t10, e10, i10, s10) {
      ...
      } }, ie = { attractive: function(t10, e10, i10, s10) {
      ...
      class ii {
        ...
        divideBox() {
          ...
          this.nodes[0] = new ii({ left: this.box.left, top: this.box.top, width: t10, height: e10 }), this.nodes[1] = new ii({ left: this.box.left + t10, top: this.box.top, width: t10, height: e10 }), this.nodes[2] = new ii({ left: this.box.left + t10, top: this.box.top + e10, width: t10, height: e10 }), this.nodes[3] = new ii({ left: this.box.left, top: this.box.top + e10, width: t10, height: e10 });
        }
        getBoxPosition(t10) {
      ...
      let is = class {
        constructor(t10, e10, i10, s10) {
          this.box = { left: t10, top: e10, width: i10, height: s10 }, this.maxDepth = 25, this.root = new ii(this.box), this.root.isInternal = true, this.root.isRoot = true, this.root.divideBox();
        }
      ...
      }, { win: io } = y(), { clamp: ia, defined: ir, isFunction: il, fireEvent: ih, pick: ip } = y();
      class id {
        constructor() {
        ...
        init(t10) {
          this.options = t10, this.nodes = [], this.links = [], this.series = [], this.box = { x: 0, y: 0, width: 0, height: 0 }, this.setInitialRendering(true), this.integration = e2.integrations[t10.integration], this.enableSimulation = t10.enableSimulation, this.attractiveForce = ip(t10.attractiveForce, this.integration.attractiveForceFunction), this.repulsiveForce = ip(t10.repulsiveForce, this.integration.repulsiveForceFunction), this.approximation = t10.approximation;
        }
      ...
      let ic = id, { addEvent: iu, defined: ig, pick: im } = y();
      function ib() {
      ...
      class ix extends ic {
        ...
        setCircularPositions() {
          var _a;
          let t10 = this.box, e10 = [...this.nodes, ...((_a = this == null ? void 0 : this.chart) == null ? void 0 : _a.allParentNodes) || []], i10 = 2 * Math.PI / (e10.length + 1), s10 = this.options.initialPositionRadius, o2, a2, r2 = 0;
        ...
        repulsiveForces() {
          var _a, _b, _c;
          let { options: t10, k: e10 } = this, { bubblePadding: i10 = 0, seriesInteraction: s10 } = t10, o2 = [...this.nodes, ...((_a = this == null ? void 0 : this.chart) == null ? void 0 : _a.allParentNodes) || []];
          for (let t11 of o2) {
            let a2 = t11.series, r2 = t11.fixedPosition, n2 = (((_b = t11.marker) == null ? void 0 : _b.radius) || 0) + i10;
            for (let i11 of (t11.degree = t11.mass, t11.neighbours = 0, o2)) {
              let o3 = i11.series;
              if (t11 !== i11 && !r2 && (s10 || a2 === o3) && !(a2 === o3 && (i11.isParentNode || t11.isParentNode))) {
                let s11, o4 = this.getDistXY(t11, i11), a3 = this.vectorLength(o4) - (n2 + (((_c = i11.marker) == null ? void 0 : _c.radius) || 0));
        ...
        resolveSplitSeries(t10) {
          ...
          return !ig(e10) && ((_h = (_g = (_f = (_e = (_d = t10.series.chart) == null ? void 0 : _d.options) == null ? void 0 : _e.plotOptions) == null ? void 0 : _f.packedbubble) == null ? void 0 : _g.layoutAlgorithm) == null ? void 0 : _h.splitSeries) || e10 || false;
        }
        applyLimitBox(t10, e10) {
          let i10, s10;
      ...
      let { merge: iP, syncTimeout: iv } = y(), { animObject: iM } = y();
      var iL = f(28), ik = f.n(iL);
      let { deg2rad: iw } = y(), { addEvent: iA, merge: iS, uniqueKey: iN, defined: iT, extend: iC } = y();
      function iX(t10, e10) {
        e10 = iS(true, { enabled: true, attributes: { dy: -5, startOffset: "50%", textAnchor: "middle" } }, e10);
        ...
        if (t10 = t10 || o2 && o2.path, o2 && o2.undo(), t10 && r2) {
          let e11 = iA(s10, "afterModifyTree", (e12) => {
            if (t10 && r2) {
              ...
              let r3 = { x: 0, y: 0 };
              iT(a2.dx) && (r3.dx = a2.dx, delete a2.dx), iT(a2.dy) && (r3.dy = a2.dy, delete a2.dy), s10.attr(r3), this.attr({ transform: "" }), this.box && (this.box = this.box.destroy());
              let n2 = e12.nodes.slice(0);
              e12.nodes.length = 0, e12.nodes[0] = { tagName: "textPath", attributes: iC(a2, { "text-anchor": a2.textAnchor, href: `${i10}#${o3}` }), children: n2 };
            }
          });
      ...
      function iY(t10) {
        ...
        if (i10) {
          let t11 = [], { b: s10, h: o2 } = this.renderer.fontMetrics(this.element), a2 = o2 - s10, r2 = RegExp('(<tspan>|<tspan(?!\\sclass="highcharts-br")[^>]*>|<\\/tspan>)', "g"), n2 = i10.innerHTML.replace(r2, "").split(/<tspan class="highcharts-br"[^>]*>/), l2 = n2.length, h2 = (t12, e11) => {
            let { x: o3, y: r3 } = e11, n3 = (i10.getRotationOfChar(t12) - 90) * iw, l3 = Math.cos(n3), h3 = Math.sin(n3);
      ...
      let { parse: iR } = eF(), { noop: iE } = y(), { series: { prototype: iz }, seriesTypes: { bubble: iD } } = P(), { initDataLabels: iO, initDataLabelsDefer: iH } = { initDataLabels: function() {
        ...
        return this.dataLabelsGroup.attr(iP({ opacity: 1 }, this.getPlotBox("data-labels"))), this.dataLabelsGroup;
      }, initDataLabelsDefer: function() {
        var _a;
        let t10 = this.options.dataLabels;
        (t10 == null ? void 0 : t10.defer) && ((_a = this.options.layoutAlgorithm) == null ? void 0 : _a.enableSimulation) ? iv(() => {
          this.deferDataLabels = false;
        }, t10 ? iM(t10.animation).defer : 0) : this.deferDataLabels = false;
      } }, { addEvent: iB, clamp: iW, defined: iF, extend: iG, fireEvent: iq, isArray: iV, isNumber: i_, merge: iU, pick: iK } = y();
      ...
      class iZ extends iD {
        ...
        addSeriesLayout() {
          let t10 = this.options.layoutAlgorithm = this.options.layoutAlgorithm || {}, e10 = t10.type || "packedbubble", i10 = this.chart.graphLayoutsStorage, s10 = this.chart.graphLayoutsLookup, o2 = iU(t10, t10.parentNodeOptions, { enableSimulation: this.layout.options.enableSimulation }), a2 = i10[e10 + "-series"];
        ...
        createParentNodes() {
          let t10 = this.pointClass, e10 = this.chart, i10 = this.parentNodeLayout, s10 = this.layout.options, o2, a2 = this.parentNode, r2 = { radius: this.parentNodeRadius, lineColor: this.color, fillColor: iR(this.color).brighten(0.4).get() };
        ...
        drawGraph() {
          ...
          let t10 = this.chart, e10 = this.layout.options.parentNodeOptions.marker, i10 = { fill: e10.fillColor || iR(this.color).brighten(0.4).get(), opacity: e10.fillOpacity, stroke: e10.lineColor || this.color, "stroke-width": iK(e10.lineWidth, this.options.lineWidth) }, s10 = {};
          this.parentNodesGroup = this.plotGroup("parentNodesGroup", "parentNode", this.visible ? "inherit" : "hidden", 0.1, t10.seriesGroup), (_a = this.group) == null ? void 0 : _a.attr({ zIndex: 2 }), this.calculateParentRadius(), this.parentNode && iF(this.parentNode.plotX) && iF(this.parentNode.plotY) && iF(this.parentNodeRadius) && (s10 = iU({ x: this.parentNode.plotX - this.parentNodeRadius, y: this.parentNode.plotY - this.parentNodeRadius, width: 2 * this.parentNodeRadius, height: 2 * this.parentNodeRadius }, i10), this.parentNode.graphic || (this.graph = this.parentNode.graphic = t10.renderer.symbol(i10.symbol).add(this.parentNodesGroup)), this.parentNode.graphic.attr(s10));
        }
        drawTracker() {
        ...
        onMouseUp(t10) {
          if (t10.fixedPosition && !t10.removed) {
            ...
            !t10.isParentNode && s10 && i10.options.dragBetweenSeries && s10.nodes.forEach((s11) => {
              t10 && t10.marker && s11 !== t10.series.parentNode && (e10 = i10.getDistXY(t10, s11), i10.vectorLength(e10) - s11.marker.radius - t10.marker.radius < 0 && (s11.series.addPoint(iU(t10.options, { plotX: t10.plotX, plotY: t10.plotY }), false), i10.removeElementFromCollection(t10, i10.nodes), t10.remove()));
        ...
        translate() {
          ...
          for (let n2 of (this.generatePoints(), iF(s10.allDataPoints) || (s10.allDataPoints = this.accumulateAllPoints(), this.getPointRadius()), r2 ? i10 = s10.allDataPoints : (i10 = this.placeBubbles(s10.allDataPoints), this.options.draggable = false), i10)) n2[3] === a2 && (t10 = o2[n2[4]], e10 = iK(n2[2], void 0), r2 || (t10.plotX = n2[0] - s10.plotLeft + s10.diffX, t10.plotY = n2[1] - s10.plotTop + s10.diffY), i_(e10) && (t10.marker = iG(t10.marker, { radius: e10, width: 2 * e10, height: 2 * e10 }), t10.radius = e10));
          r2 && this.deferLayout(), iq(this, "afterTranslate");
        }
      }
      iZ.defaultOptions = iU(iD.defaultOptions, { minSize: "10%", maxSize: "50%", sizeBy: "area", zoneAxis: "y", crisp: false, tooltip: { pointFormat: "Value: {point.value}" }, draggable: true, useSimulation: true, parentNode: { allowPointSelect: false }, dataLabels: { formatter: function() {
        let { numberFormatter: t10 } = this.series.chart, { value: e10 } = this.point;
        return e4(e10) ? t10(e10, -1) : "";
      }, parentNodeFormatter: function() {
        return this.name || "";
      }, parentNodeTextPath: { enabled: true }, padding: 0, style: { transition: "opacity 2000ms" } }, layoutAlgorithm: { initialPositions: "circle", initialPositionRadius: 20, bubblePadding: 5, parentNodeLimit: false, seriesInteraction: true, dragBetweenSeries: false, parentNodeOptions: { maxIterations: 400, gravitationalConstant: 0.03, maxSpeed: 50, initialPositionRadius: 100, seriesInteraction: true, marker: { fillColor: null, fillOpacity: 1, lineWidth: null, lineColor: null, symbol: "circle" } }, enableSimulation: true, type: "packedbubble", integration: "packedbubble", maxIterations: 1e3, splitSeries: false, maxSpeed: 5, gravitationalConstant: 0.01, friction: -0.981 }, stickyTracking: false }), iG(iZ.prototype, { pointClass: e6, axisTypes: [], directTouch: true, forces: ["barycenter", "repulsive"], hasDraggableNodes: true, invertible: false, isCartesian: false, noSharedTooltip: true, pointArrayMap: ["value"], pointValKey: "value", requireSorting: false, trackerGroups: ["group", "dataLabelsGroup", "parentNodesGroup"], initDataLabels: iO, alignDataLabel: iz.alignDataLabel, indexateNodes: iE, onMouseDown: eU.onMouseDown, onMouseMove: eU.onMouseMove, redrawHalo: eU.redrawHalo, searchPoint: iE }), P().registerSeriesType("packedbubble", iZ);
      let { noop: ij } = y(), { area: i$, line: iQ, scatter: iJ } = P().seriesTypes, { extend: i0, merge: i1 } = y();
      class i2 extends iJ {
        getGraphPath() {
      ...
      i2.defaultOptions = i1(iJ.defaultOptions, { marker: { enabled: false, states: { hover: { enabled: false } } }, stickyTracking: false, tooltip: { followPointer: true, pointFormat: "" }, trackByArea: true, legendSymbol: "rectangle" }), i0(i2.prototype, { type: "polygon", drawTracker: iQ.prototype.drawTracker, setStackedPoints: ij }), P().registerSeriesType("polygon", i2);
      let i3 = { circular: { gridLineWidth: 1, labels: { align: void 0, x: 0, y: void 0 }, maxPadding: 0, minPadding: 0, showLastLabel: false, tickLength: 0 }, radial: { gridLineInterpolation: "circle", gridLineWidth: 1, labels: { align: "right", padding: 5, x: -3, y: -2 }, showLastLabel: false, title: { x: 4, text: null, rotation: 90 } }, radialGauge: { endOnTick: false, gridLineWidth: 0, labels: { align: "center", distance: -25, x: 0, y: void 0 }, lineWidth: 1, minorGridLineWidth: 0, minorTickInterval: "auto", minorTickLength: 10, minorTickPosition: "inside", minorTickWidth: 1, startOnTick: false, tickLength: 10, tickPixelInterval: 100, tickPosition: "inside", tickWidth: 2, title: { rotation: 0, text: "" }, zIndex: 2 } }, { defaultOptions: i5 } = y(), { composed: i8, noop: i6 } = y(), { addEvent: i4, correctFloat: i9, defined: i7, extend: st, fireEvent: se, isObject: si, merge: ss, pick: so, pushUnique: sa, relativeLength: sr, wrap: sn } = y();
      !function(t10) {
        function e10() {
        ...
        function n2(t11, e11, i11) {
          ...
          if ("polygon" === this.options.gridLineInterpolation) y2 = this.getPlotLinePath({ value: t11 }).concat(this.getPlotLinePath({ value: e11, reverse: true }));
            ...
            c3 || (x3 = o4 || 0, P3 = n4 || 0), "circle" !== i11.shape && c3 ? (u3 = r3 + (o4 || 0), g3 = r3 + (n4 || 0)) : (u3 = -Math.PI / 2, g3 = 1.5 * Math.PI, b3 = true), x3 -= l3, v3 -= l3, y2 = s11.renderer.symbols.arc(h3 + a3[0], p3 + a3[1], x3, x3, { start: Math.min(u3, g3), end: Math.max(u3, g3), innerR: so(P3, x3 - v3), open: b3, borderRadius: i11.borderRadius }), c3 && (f3 = (g3 + u3) / 2, m3 = h3 + a3[0] + a3[2] / 2 * Math.cos(f3), y2.xBounds = f3 > -Math.PI / 2 && f3 < Math.PI / 2 ? [m3, s11.plotWidth] : [0, m3], y2.yBounds = [p3 + a3[1] + a3[2] / 2 * Math.sin(f3)], y2.yBounds[0] += f3 > -Math.PI && f3 < 0 || f3 > Math.PI ? -10 : 10);
          }
          return y2;
        }
        function l2(t11) {
        ...
        function c2() {
          let t11 = this.chart, e11 = this.options, i11 = t11.angular && this.isXAxis, s11 = this.pane, o3 = s11 == null ? void 0 : s11.options;
        ...
        function b2(t11) {
          ...
          i11.isRadial && (h3 = i11.getPosition(this.pos, i11.center[2] / 2 + sr(so(o3.distance, -25), i11.center[2] / 2, -i11.center[2] / 2)), "auto" === o3.rotation ? e11.attr({ rotation: a3 }) : i7(l3) || (l3 = i11.chart.renderer.fontMetrics(e11).b - s11.height / 2), i7(d3) || (i11.isCircular ? (s11.width > i11.len * i11.tickInterval / (i11.max - i11.min) && (p3 = 0), d3 = a3 > p3 && a3 < 180 - p3 ? "left" : a3 > 180 + p3 && a3 < 360 - p3 ? "right" : "center") : d3 = "center", e11.attr({ align: d3 })), "auto" === d3 && 2 === i11.tickPositions.length && i11.isCircular && (u3 > 90 && u3 < 180 ? u3 = 180 - u3 : u3 > 270 && u3 <= 360 && (u3 = 540 - u3), g3 > 180 && g3 <= 360 && (g3 = 360 - g3), (i11.pane.options.startAngle === r3 || i11.pane.options.startAngle === r3 + 360 || i11.pane.options.startAngle === r3 - 360) && (c3 = "start"), d3 = r3 >= -90 && r3 <= 90 || r3 >= -360 && r3 <= -270 || r3 >= 270 && r3 <= 360 ? "start" === c3 ? "right" : "left" : "start" === c3 ? "left" : "right", g3 > 70 && g3 < 110 && (d3 = "center"), u3 < 15 || u3 >= 180 && u3 < 195 ? f3 = 0.3 * s11.height : u3 >= 15 && u3 <= 35 ? f3 = "start" === c3 ? 0 : 0.75 * s11.height : u3 >= 195 && u3 <= 215 ? f3 = "start" === c3 ? 0.75 * s11.height : 0 : u3 > 35 && u3 <= 90 ? f3 = "start" === c3 ? -(0.25 * s11.height) : s11.height : u3 > 215 && u3 <= 270 && (f3 = "start" === c3 ? s11.height : -(0.25 * s11.height)), g3 < 15 ? m3 = "start" === c3 ? -(0.15 * s11.height) : 0.15 * s11.height : g3 > 165 && g3 <= 180 && (m3 = "start" === c3 ? 0.15 * s11.height : -(0.15 * s11.height)), e11.attr({ align: d3 }), e11.translate(m3, f3 + n3)), t11.pos.x = h3.x + (o3.x || 0), t11.pos.y = h3.y + (l3 || 0));
        }
        function x2(t11) {
      ...
      let sl = d, { animObject: sh } = y(), { composed: sp } = y(), { addEvent: sd, defined: sc, find: su, isNumber: sg, merge: sf, pick: sm, pushUnique: sb, relativeLength: sy, splat: sx, uniqueKey: sP, wrap: sv } = y();
      function sM() {
        ...
        if (this.chart.polar && this.xAxis) {
          ...
          this.hasClipCircleSetter || (this.hasClipCircleSetter = !!this.eventsToUnbind.push(sd(this, "afterRender", function() {
            ...
            i10.polar && false !== this.options.clip && (t11 = this.yAxis.pane.center, this.clipCircle ? this.clipCircle.animate({ x: t11[0], y: t11[1], r: t11[2] / 2, innerR: t11[3] / 2 }) : this.clipCircle = function(t12, e11, i11, s11, o3) {
              let a2 = sP(), r2 = t12.createElement("clipPath").attr({ id: a2 }).add(t12.defs), n2 = o3 ? t12.arc(e11, i11, s11, o3, 0, 2 * Math.PI).add(r2) : t12.circle(e11, i11, s11).add(r2);
      ...
      function sY(t10, e10, i10, s10, o2, a2) {
        ...
        if (h2.polar) {
          if (r2 = e10.rectPlotX / Math.PI * 180, h2.inverted) this.forceDL = h2.isInsidePlot(e10.plotX, e10.plotY), p2 && e10.shapeArgs ? (n2 = e10.shapeArgs, o2 = sf(o2, { x: (l2 = this.yAxis.postTranslate(((n2.start || 0) + (n2.end || 0)) / 2 - this.xAxis.startAngleRad, e10.barX + e10.pointWidth / 2)).x - h2.plotLeft, y: l2.y - h2.plotTop })) : e10.tooltipPos && (o2 = sf(o2, { x: e10.tooltipPos[0], y: e10.tooltipPos[1] })), s10.align = sm(s10.align, "center"), s10.verticalAlign = sm(s10.verticalAlign, "middle");
          else {
            var d2;
      ...
      function sI() {
        ...
        if (s10.isRadial) for (u2 = (d2 = this.points).length, g2 = o2.translate(o2.min), f2 = o2.translate(o2.max), h2 = t10.threshold || 0, i10.inverted && sg(h2) && sc(p2 = o2.translate(h2)) && (p2 < 0 ? p2 = 0 : p2 > l2 && (p2 = l2), this.translatedThreshold = p2 + n2); u2--; ) {
          if (k2 = (c2 = d2[u2]).barX, P2 = c2.x, v2 = c2.y, c2.shapeType = "arc", i10.inverted) {
            ...
            c2.shapeArgs = { x: r2[0], y: r2[1], r: A2, innerR: w2, start: m2, end: b2, borderRadius: s11 }, c2.opacity = m2 === b2 ? 0 : void 0, c2.plotY = (sc(this.translatedThreshold) && (m2 < this.translatedThreshold ? m2 : b2)) - n2;
      ...
      class sB {
        static compose(t10, e10, i10, s10, o2, a2, r2, n2, l2, h2) {
          if (F.compose(e10, i10), sl.compose(t10, o2), sb(sp, "Polar")) {
            ...
            if (sd(e10, "afterDrawChartBox", sM), sd(e10, "createAxes", sk), sd(e10, "init", sL), sv(t11, "get", sX), sv(p2, "getCoordinates", sE), sv(p2, "pinch", sz), sd(i10, "getSelectionMarkerAttrs", sA), sd(i10, "getSelectionBox", sw), sd(s10, "afterInit", sS), sd(s10, "afterTranslate", sN, { order: 2 }), sd(s10, "afterColumnTranslate", sI, { order: 4 }), sv(d2, "animate", sD), sv(o3, "pos", sH), n2) {
      ...
      let { composed: sG } = y(), { addEvent: sq, objectEach: sV, pushUnique: s_ } = y();
      !function(t10) {
        function e10() {
        ...
        function i10() {
          ...
          (t11 == null ? void 0 : t11.enabled) && this.waterfall.stacks && this.waterfall.renderStackTotals();
        }
        function s10() {
        ...
        class a2 {
          ...
          renderStackTotals() {
            var _a2;
            let t11 = this.axis, e11 = t11.waterfall.stacks, i11 = (_a2 = t11.stacking) == null ? void 0 : _a2.stackTotalGroup, s11 = new (sF())(t11, t11.options.stackLabels || {}, false, 0, void 0);
      ...
      let { column: sj, line: s$ } = P().seriesTypes, { addEvent: sQ, arrayMax: sJ, arrayMin: s0, correctFloat: s1, crisp: s2, extend: s3, isNumber: s5, merge: s8, objectEach: s6, pick: s4 } = y();
      function s9(t10, e10) {
      ...
      class s7 extends sj {
        ...
        processData(t10) {
          ...
          s10 = i10 = o2 = a2 = 0;
          for (let t11 = 0; t11 < p2; t11++) r2 = l2[t11], e10 = (h2 == null ? void 0 : h2[t11]) || {}, "sum" === r2 || e10.isSum ? l2[t11] = s1(s10) : "intermediateSum" === r2 || e10.isIntermediateSum ? (l2[t11] = s1(i10), i10 = 0) : (s10 += r2, i10 += r2), o2 = Math.min(s10, o2), a2 = Math.max(s10, a2);
        ...
        getCrispPath() {
          var _a;
          let t10 = this.data.filter((t11) => s5(t11.y)), e10 = this.yAxis, i10 = t10.length, s10 = ((_a = this.graph) == null ? void 0 : _a.strokeWidth()) || 0, o2 = this.xAxis.reversed, a2 = this.yAxis.reversed, r2 = this.options.stacking, n2 = [];
        ...
        drawGraph() {
          s$.prototype.drawGraph.call(this), this.graph && this.graph.attr({ d: this.getCrispPath() });
        }
        ...
        getExtremes() {
          ...
          }), { dataMin: s0(e10), dataMax: sJ(i10) }) : { dataMin: this.dataMin, dataMax: this.dataMax };
        }
      }
      s7.defaultOptions = s8(sj.defaultOptions, { dataLabels: { inside: true }, lineWidth: 1, lineColor: "#333333", dashStyle: "Dot", borderColor: "#333333", states: { hover: { lineWidthPlus: 0 } } }), s7.compose = sU.compose, s3(s7.prototype, { pointValKey: "y", showLine: true, pointClass: sZ }), sQ(s7, "afterColumnTranslate", function() {
        let { options: t10, points: e10, yAxis: i10 } = this, s10 = s4(t10.minPointLength, 5), o2 = s10 / 2, a2 = t10.threshold || 0, r2 = t10.stacking, n2 = i10.waterfall.stacks[this.stackKey], l2 = this.getColumn("y", true), h2 = a2, p2 = a2, d2, c2, u2, g2;
        for (let t11 = 0; t11 < e10.length; t11++) {
          let f2 = e10[t11], m2 = l2[t11], b2 = s3({ x: 0, y: 0, width: 0, height: 0 }, f2.shapeArgs || {});
          f2.box = b2;
      ...
      }, { order: 2 }), P().registerSeriesType("waterfall", s7);
      let ot = y();
